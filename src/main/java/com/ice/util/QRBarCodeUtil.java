...
public class QRBarCodeUtil {
    ...
    public static void main(String[] args) {
        ...
        createCodeToFile(codeContent1, new File("E:\\360Downloads"), null, null);

        String codeContent2 = "4c86fed8-7ac9-4db7-956e-6cfe84268059";
        createCodeToFile(codeContent2, new File("E:\\360Downloads"), null, null);
     ...
     */
    public static BufferedImage createCodeToFile(String codeContent, File codeImgFileSaveDir, String fileName, HttpServletResponse response) {
        try {
            /** 参数检验*/
